function [traj,err] = lka_trajectory_klothoide(swPlot,delta)
...
p1 = createTraj('cloth2',xyStart,kStart,kStop,A,slopeStart,0.05);
% p2 = createTraj('cloth2',xyStart,kStart,kStop,A,slopeStart,0.05);
% segment 2:
